...
<body class="container">
	...
	style="font-family: 'Abril Fatface', cursive;"> Shopping Cart Option </h1>
	...
	mysqli_select_db($con,'mobileshopee');
	...
	$query = " SELECT `p_name`, `image`, `price`, `discount` FROM `mobileshopping` order by id ASC ";
